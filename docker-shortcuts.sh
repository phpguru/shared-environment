...
drun() {
  ...
  case "$1" in
    ...
    "pgadmin4" )
	      docker run --name pgadmin4 -p 81:80 -v pgadmin_storage:/var/lib/pgadmin/storage --dns=172.17.0.1 --dns=10.90.0.2 --dns=8.8.8.8 -e 'PGADMIN_DEFAULT_EMAIL=root@localhost' -e 'PGADMIN_DEFAULT_PASSWORD=P@55w0rd' -d dpage/pgadmin4;;
